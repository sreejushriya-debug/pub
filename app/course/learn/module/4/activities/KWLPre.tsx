  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 4 KWL – Before You Start</h2>
        <p className="text-gray-600">Let&apos;s see what you know about starting a business!</p>
      </div>
      ...
      <div className="bg-forest-50 border border-forest-200 rounded-xl p-4 mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-forest-700">I can understand revenue, expenses, profit, and how to start my own business.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mb-3">What do you know about businesses, profit, or expenses?</p>
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mb-3">What questions do you have about running a business?</p>
