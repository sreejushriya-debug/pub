  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 2 KWL – Reflection</h2>
        <p className="text-gray-600">Great job completing Module 2! Now let&apos;s reflect on what you learned.</p>
      </div>

      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div>
          <label className="block font-semibold text-gray-900 mb-2">K – What I <span className="text-forest-600">Knew</span> (Before)</label>
        ...
        <div>
          <label className="block font-semibold text-gray-900 mb-2">W – What I <span className="text-accent-600">Wanted</span> to Know (Before)</label>
        ...
        <div>
          <label className="block font-semibold text-gray-900 mb-2">L – What I <span className="text-sage-600">Learned</span> (Now)</label>
          <p className="text-sm text-gray-500 mb-2">What did you learn about saving, spending, and budgeting?</p>
          ...
          <p className="text-xs text-gray-400 mt-1">{learned.length}/40 characters minimum</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-forest-50 to-accent-50 rounded-xl p-6 mb-8">
        ...
        <ul className="text-gray-700 space-y-1 text-sm">
          <li>• What&apos;s the difference between wants and needs?</li>
          <li>• How do you create a budget?</li>
          <li>• When should you save vs spend?</li>
        </ul>
      </div>
      ...
      <div className="flex justify-center">
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleSubmit} className="btn-primary text-lg px-8 py-4">
          Complete Module 2 🎉 <ArrowRight className="w-5 h-5 ml-2" />
        </motion.button>
      </div>
    </div>
  )
