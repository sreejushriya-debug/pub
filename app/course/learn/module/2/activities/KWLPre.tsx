  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 2 KWL – Before You Start</h2>
        <p className="text-gray-600">Let&apos;s see what you already know about saving and spending!</p>
      </div>
      ...
      <div className="bg-forest-50 border border-forest-200 rounded-xl p-4 mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-forest-700">I can understand healthy saving and spending habits, and create a budget.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mb-3">What do you know about saving, spending, or budgeting?</p>
          ...
          <p className="text-xs text-gray-400 mt-1">{know.length}/20 characters minimum</p>
        </div>

        <div>
          <label className="block font-semibold text-gray-900 mb-2">W – What I <span className="text-accent-600">Want</span> to Know</label>
          <p className="text-sm text-gray-500 mb-3">What questions do you have about managing money?</p>
          ...
          <p className="text-xs text-gray-400 mt-1">{want.length}/20 characters minimum</p>
        </div>

        <div>
          <label className="block font-semibold text-gray-900 mb-2">L – What I <span className="text-sage-600">Learned</span></label>
          <p className="text-sm text-gray-500 mb-3">You&apos;ll fill this out after finishing the module!</p>
