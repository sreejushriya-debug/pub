  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 3 KWL – Reflection</h2>
        <p className="text-gray-600">Great job! Now reflect on what you learned about banking.</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-forest-50 to-accent-50 rounded-xl p-6 mb-8">
        ...
        <ul className="text-gray-700 space-y-1 text-sm">
          <li>• What&apos;s the difference between credit and debit?</li>
          <li>• How do you read a stock chart?</li>
          <li>• What are the parts of a check?</li>
        </ul>
      </div>
