  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 5 KWL – Reflection</h2>
        <p className="text-gray-600">Great job! Now reflect on what you learned about taxes and discounts.</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-forest-50 to-accent-50 rounded-xl p-6 mb-8">
        ...
        <ul className="text-gray-700 space-y-1 text-sm">
          <li>• How do you calculate sales tax?</li>
          <li>• What&apos;s the difference between discount and tax?</li>
          <li>• How can you find the best deal when shopping?</li>
        </ul>
      </div>
