  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 6 KWL – Before You Start</h2>
        <p className="text-gray-600">Let&apos;s review everything you&apos;ve learned!</p>
      </div>
      ...
      <div className="bg-forest-50 border border-forest-200 rounded-xl p-4 mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-forest-700">I can apply all my financial literacy skills to real-world scenarios and demonstrate mastery of budgeting, saving, spending, business, taxes, and credit.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mb-3">What do you remember from the previous modules?</p>
        ...
        <div>
          <label className="block font-semibold text-gray-900 mb-2">W – What I <span className="text-accent-600">Want</span> to Review</label>
          <p className="text-sm text-gray-500 mb-3">What topics do you want to practice more?</p>
          <textarea value={want} onChange={(e) => { setWant(e.target.value); setErrors({ ...errors, want: undefined }) }}
            placeholder="I want to review..." className={`w-full h-40 p-4 border-2 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-accent-500 ${errors.want ? 'border-red-400 bg-red-50' : 'border-gray-200'}`} />
      ...
      <div className="flex justify-center">
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleSubmit} className="btn-primary text-lg px-8 py-4">
          Save and Start Review <ArrowRight className="w-5 h-5 ml-2" />
        </motion.button>
      </div>
    </div>
  )
