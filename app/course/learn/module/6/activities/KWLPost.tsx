  ...
  return (
    <div className="p-6 md:p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Module 6 KWL – Final Reflection</h2>
        <p className="text-gray-600">Congratulations! Reflect on your entire learning journey!</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div>
          <label className="block font-semibold text-gray-900 mb-2">W – What I <span className="text-accent-600">Wanted</span> to Review</label>
      ...
      <div className="bg-gradient-to-r from-forest-50 to-accent-50 rounded-xl p-6 mb-8">
        ...
        <ul className="text-gray-700 space-y-1 text-sm">
          <li>• How confident do you feel about managing money?</li>
          <li>• What was the most important thing you learned?</li>
          <li>• How will you use these skills in real life?</li>
        </ul>
      </div>
