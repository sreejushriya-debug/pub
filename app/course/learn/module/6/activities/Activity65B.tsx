...
export default function Activity65B({ quizScore, onComplete }: Props) {
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div ref={setCertificateRef} className="bg-gradient-to-br from-amber-50 via-white to-amber-50 border-4 border-amber-300 rounded-2xl p-12 mb-8 max-w-3xl mx-auto shadow-2xl print:shadow-none">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6 max-w-2xl mx-auto">
